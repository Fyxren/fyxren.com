    ...
    <div className="flex flex-col h-screen max-h-screen select-none">
      ...
      <main className="flex justify-center h-full p-5 -mt-20 text-center md:mt-auto lg:text-left lg:p-20">
        <div className="flex-col gap-20 hero-content lg:gap-40 lg:flex-row-reverse">
          <img src="/images/logo.png" className="w-40 duration-300 rounded-lg shadow-2xl md:w-52 lg:w-64 lg:hover:-translate-y-10 lg:hover:rotate-3 lg:hover:scale-125" />
          <div>
