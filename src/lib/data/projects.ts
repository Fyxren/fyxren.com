...
export default [
    ...
    },
    {
        ...
        description: '🤖 • A Discord.js (/) command, event, permissions & cooldowns handler for Discord.js V14.',
    ...
    {
        name: 'E-SEVEN',
        description: '🎤 • An (unofficial) website for E-SEVEN. Three friends who have been making music for years.',
        category: Category.website,
        image: null,
        status: 'active',
        chips: [
